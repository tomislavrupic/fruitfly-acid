...
export const DEFAULT_TONE=Object.freeze({cutoff:1100,resonance:7,volume:.22,decay:.24,delayTime:.3,feedback:.35,wet:.2,kickLevel:.5,kickOn:1});
...
export function validateSession(d,graph){
 ...
 const tone=d.tone===undefined?{...DEFAULT_TONE}:d.tone===null?null:{decay:DEFAULT_TONE.decay,delayTime:.3,feedback:.35,wet:.2,kickLevel:.5,kickOn:1,...d.tone};
