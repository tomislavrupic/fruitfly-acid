...
const fixture=()=>({version:1,graphVersion:graph.version,pattern,slots:[pattern,null,null,null],brain:brain.export(),frozen:true,learned:2,tone:{cutoff:2400,resonance:9.2,volume:.13,decay:.4,delayTime:.3,feedback:.35,wet:.2,kickLevel:.5,kickOn:1}});
...
test('legacy sessions receive default tone; invalid tone and seed are rejected',async()=>{
 ...
 assert.deepEqual(validateSession(old,graph).tone,{cutoff:1100,resonance:7,volume:.22,decay:.24,delayTime:.3,feedback:.35,wet:.2,kickLevel:.5,kickOn:1});
