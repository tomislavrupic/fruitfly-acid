...
await mkdir('dist/assets');await copyFile('assets/fly-concept-v1.png','dist/assets/fly-concept-v1.png');await cp('data','dist/data',{recursive:true});await writeFile('dist/.nojekyll','');
